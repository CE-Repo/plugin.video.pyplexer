...
from companion.utils import get_audio_player_id
from companion.utils import get_photo_player_id
from companion.utils import get_players
from companion.utils import get_plex_headers
from companion.utils import get_video_player_id
from companion.utils import get_volume
from companion.utils import get_xml_header
from companion.utils import jsonrpc
from companion.utils import kodi_photo
from companion.utils import kodi_video
from companion.utils import plex_audio
from companion.utils import plex_photo
from companion.utils import plex_video
from companion.utils import time_to_millis
...
class SubscriptionManager:  # pylint: disable=too-many-instance-attributes,
    ...
    def get_server(self):
        server = str(WINDOW.getProperty('plugin.video.pyplexer-nowplaying.server'))
        if server:
            self.server, self.port = server.split(':')

    @staticmethod
    def get_key_id():
        return str(WINDOW.getProperty('plugin.video.pyplexer-nowplaying.id'))
