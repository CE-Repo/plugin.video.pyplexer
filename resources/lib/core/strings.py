...
STRINGS = {
    ...
    'Watchlist': 30815,
    'Discover': 30816,
    'This title is not available on any of your servers': 30817,
    'Add to Watchlist': 30818,
    'Remove from Watchlist': 30819,
...
def i18n(string_id):
    ...
    return CONFIG['addon'].getLocalizedString(string_id)


def i18n_or(string_id, fallback):
    """Like i18n() but returns a fallback when the (possibly newly added) string
    has not been loaded by Kodi yet, so labels are never blank."""
    text = i18n(string_id)
